...
function selectedPack() {
    ...
    if (pack.includes("MATERIAL_ICONS_")) link2.href = "./fonts/MATERIAL_ICONS/font.css";
    else if (pack.includes("MATERIAL_SYMBOLS_")) link2.href = "./fonts/MATERIAL_SYMBOLS/font.css";
    searchdata();
}
const dataMap = new Map([
    [
        "FREE_FONT_AWESOME_ALL",
        "./fonts/FREE_FONT_AWESOME_ALL/font.json"
    ],
    [
        "MATERIAL_SYMBOLS_OUTLINED",
        "./fonts/MATERIAL_SYMBOLS/font.json"
    ],
    [
        "MATERIAL_SYMBOLS_ROUNDED",
        "./fonts/MATERIAL_SYMBOLS/font.json"
    ...
    [
        "MATERIAL_ICONS_FILLED",
        "./fonts/MATERIAL_ICONS/font.json"
    ],
    [
        "MATERIAL_ICONS_OUTLINED",
        "./fonts/MATERIAL_ICONS/font.json"
...
const prefixMap = new Map([
    ...
    [
        "MATERIAL_ICONS_SHARP",
        "mi material-icons-sharp"
    ],
    [
        "MATERIAL_ICONS_TWO_TONE",
        "mi material-icons-two-tone"
    ]
]);
function searchdata() {
    const pack = packs.value;
    ...
    fetch(dataMap.get(pack)).then((response)=>response.json()).then((data)=>{
